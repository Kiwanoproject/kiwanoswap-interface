...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `//images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `//images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `//images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
