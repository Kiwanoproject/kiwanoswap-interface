...
import { Text, Flex, AccountIcon, TeamBattleIcon, Box, useTooltip, LinkExternal } from '@kiwanoproject/uikit'
      ...
      element={
        <>
          <LinkExternal
            ...
            href={`//nfts/collections/${admissionProfile}`}
          >
            {t('Pancake Squad NFT')}
          </LinkExternal>
          <br />
    ...
    <TransWithElement
      ...
      element={
        <>
          ...
          <LinkExternal
            style={{ display: 'inline' }}
            href={`//nfts/profile/${account}/achievements/`}
          >
            {t('Pancake Profile')}
          </LinkExternal>
        </>
