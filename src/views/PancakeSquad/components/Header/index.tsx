...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@kiwanoproject/uikit'
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('KiwanoSwap’s first official generative NFT collection.')}
      </Text>
