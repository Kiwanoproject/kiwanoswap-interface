  ...
  return (
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={2} title={t('Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {t(
            'Trade MBOX/BNB, MBOX/BUSD, WANO/BNB and WANO/BUSD during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>
