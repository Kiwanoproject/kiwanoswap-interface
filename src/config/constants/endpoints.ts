...
export const INFO_CLIENT = 'https://api.thegraph.com/subgraphs/name/kiwanoproject/exchange'
export const BLOCKS_CLIENT = 'https://api.thegraph.com/subgraphs/name/kiwanoproject/blocks'
